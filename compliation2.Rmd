...
subsetTeams %>%
  ...
  ggplot(., aes(x = factor(PenaltyTeam), y = PenPerGame)) +
    ...
    theme_light()+xlab('Team')+ylab('Average Penalty per Game by Referee')+ggtitle('Average Number of Penalties Given by Referee By Team: Outliers')
