...
ggplot(subsetTeams, aes(x = PenPerGame,y = reorder(PenaltyTeam, Median))) +geom_density_ridges(fill='blue',alpha= 0.4,scale=2,rel_min_height=0.01) + xlab("Penalty per Game by Referee") + theme_light()+ylab('Team')+ggtitle('Average Penalty by Team')

ggplot(penRef, aes(x = PenPerGame,y = reorder(PenaltyTeam, Median))) +geom_density_ridges(fill = 'blue',alpha = 0.4,scale=2,rel_min_height=0.01) + 
    ggtitle("Penalty per Game") + theme_light()
...
ggplot(penRef, aes(x = PenPerGame,y = reorder(Referee, Median))) +geom_density_ridges(fill = 'blue',alpha = 0.3,scale=2,rel_min_height=0.01) + 
    ggtitle("Distribution of Penalty per Game") + theme_light()+ylab('Referee')+xlab('Distribution of Average Number of Penalties per Game by Team')
